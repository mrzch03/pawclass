 ...
 * 1. **Logto JWT** (browser): Verify JWT from Authorization header, extract `sub` as userId
 * 2. **Delegation token** (CLI/Agent): Verify JWT, check `type: "delegation"` claim, extract `sub` as userId
 *
